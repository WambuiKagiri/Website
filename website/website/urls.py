...
from MySite.views import dashboard,home,subscribe,agentprofile, search, propertycontact,listpropertyy, paypage, listpropetrty, messagestatus, clientbookings,agenteditproperty
...
urlpatterns = [
    ...
    url(r'^agent-edit-property/',agenteditproperty,name='agentedit'),
